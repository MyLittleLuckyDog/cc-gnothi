---
cc_version: "2.1.139"
build_time: "2026-05-11T17:03:24Z"
git_sha: "208bf4b44f987c4c62618ae20ce1715d53693c62"
bundle_lines: 19399
bundle_size: "13.69 MB"
prev_version: "2.1.133"
...
| BUILD_TIME | 2026-05-11T17:03:24Z |
| GIT_SHA | `208bf4b44f987c4c62618ae20ce1715d53693c62` |
| Bundle size | 13.69 MB / 19399 lines |
| Previous version | 2.1.133 |

## Command Changes (vs 2.1.133)

| Command | Description | Change |
|---|---|---|
| `/scroll-speed` | Adjust mouse wheel scroll speed | added |


## All Slash Commands (v2.1.139)
...
- [scroll-speed.md](scroll-speed.md) — `/scroll-speed`: Adjust mouse wheel scroll speed (stub, analysis pending)

## Chapter Proposals

<!-- Populated by automation when new commands are detected. -->
- [ ] `/scroll-speed` — Adjust mouse wheel scroll speed. Review: absorb into existing chapter or create new feature-spec.
...
|---|---:|
| Total commands | 97 |
| Handler resolved | **97 / 97 (100%)** |
| via direct byte-range (path 1) | 17 |
| via module_id follow (path 2) | 76 |
